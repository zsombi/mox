...
MOX_API const MetatypeDescriptor* findMetatype(const std::function<bool(const MetatypeDescriptor&)>& predicate);
...
#include <mox/core/meta/core/detail/metadata_impl.hpp>
